...
if (file.exists("../data/mamba_data.rda") &&
  ...
  snpeffect <- mamba_data$betajk[1:500, ]
  snpvar <- mamba_data$sjk2[1:500, ]
...
save(post_prp_data, file = "../data/post_prp_data5000.rda")
save(post_prp_data_pval, file = "../data/post_prp_data5000_pval.rda")
write.csv(post_prp_data_ch, "../data/post_prp_data5000.csv", row.names = FALSE)
